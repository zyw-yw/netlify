...
export const BASE_URL = "https://api.mapbox.com/directions/v5/mapbox/walking";
...
// const a = {
//   order: [
//     {'longitude', 'latitude', 'quantity', 'productType', 'time'},
//     {'longitude', 'latitude', 'quantity', 'productType', 'time'},
//     {'longitude', 'latitude', 'quantity', 'productType', 'time'},
//   ],
//   factories: [
//     {'longitude', 'latitude', 'capacity', 'productType', 'cost'},
//     {'longitude', 'latitude', 'capacity', 'productType', 'cost'},
//     {'longitude', 'latitude', 'capacity', 'productType', 'cost'},
//   ],
// }
