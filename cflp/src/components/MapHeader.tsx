...
import { Button, Empty, List, Divider, Input } from "antd";
import {
  MenuUnfoldOutlined,
  MenuFoldOutlined,
  SettingTwoTone,
      ...
      <StyledHeader>
        <OperatorButtonWrapper>
          <ButtonsWrapper>
            ...
            {/* <Button
              type="primary"
              onClick={() => handleOpenAddModal(ADD_STORE)}
            >
              <BankTwoTone />
            </Button> */}
            {/* </>
        ...
        <div style={{ lineHeight: "32px", color: "white" }}>wuwenqi.depp</div>
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <RollbackOutlined
                  onClick={() => {
                    ...
                    // const tempHistories = await historyRollBack(userInfo?.email, item.productType);
                    // if (userInfo.userType === CLIENT_TENANT) {
